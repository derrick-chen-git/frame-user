...
public class TopicTest2RabbitmqInit implements IInitRabbitMqQueue {

    @Autowired
    private RabbitMqUtils rabbitMqUtils;

    @Value("${rabbitmq.topic.test2.exchange.name}")
    private String exchangeName;
    @Value("${rabbitmq.topic.test2.exchange.type}")
    private String exchangeType;
    @Value("${rabbitmq.topic.test2.queue.name}")
    private String queueName;
    @Value("${rabbitmq.topic.test2.route.key}")
